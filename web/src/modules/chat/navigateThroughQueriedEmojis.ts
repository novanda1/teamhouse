import { useChatTeamStore } from "./team/useChatTeamStore";
import { useEmojiPickerStore } from "./useEmojiPickerStore";

export const navigateThroughQueriedEmojis = (e: any) => {
  const { message, setMessage } = useChatTeamStore.getState();
  const {
    queryMatches,
